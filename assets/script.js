...
let questions = [
  {
    question:
      "What is the process of preserving food by heating it to destroy harmful microorganisms?",
  ...
  {
    question:
      "Which enzyme is responsible for breaking down proteins into amino acids during digestion?",
    choice1: "Amylase",
    choice2: "Lipase",
    choice3: "Protease",
    choice4: "Cellulase",
  ...
  {
    question:
      "What is the primary purpose of pasteurization in the food industry?",
  ...
  {
    question:
      "Which vitamin is commonly found in citrus fruits such as oranges and lemons?",
    choice1: "Vitamin A",
    choice2: "Vitamin C",
    choice3: "Vitamin D",
    choice4: "Vitamin K",
  ...
  {
    question:
      "What is the role of sodium chloride (salt) in food preservation?",
  ...
  {
    question:
      "Which food additive is used as a thickening agent in various food products?",
  ...
  {
    question:
      "Which process involves the conversion of sugars to alcohol and carbon dioxide by yeast?",
  ...
  {
    question:
      "Which food preservation method involves the removal of moisture?",
    choice1: "Freezing",
    choice2: "Canning",
    choice3: "Dehydration",
    choice4: "Pickling",
  ...
  {
    question:
      "Which type of food preservation involves the use of high temperatures to kill bacteria and enzymes?",
    choice1: "Dehydration",
    choice2: "Freezing",
    choice3: "Canning",
    choice4: "Pickling",
  ...
  {
    question:
      "Which cooking method involves submerging food in hot oil to cook quickly?",
    choice1: "Roasting",
    choice2: "Grilling",
    choice3: "Frying",
    choice4: "Steaming",
  ...
  {
    question:
      "Which food preservation method involves treating food with ionizing radiation?",
    choice1: "Dehydration",
    choice2: "Irradiation",
  ...
  {
    question:
      "Which food additive is commonly used as a stabilizer in ice cream?",
    choice1: "Carrageenan",
  ...
  {
    question:
      "Which enzyme is responsible for breaking down carbohydrates into simple sugars during digestion?",
    choice1: "Amylase",
    choice2: "Lipase",
    choice3: "Protease",
    choice4: "Cellulase",
  ...
  {
    question:
      "Which food preservation method involves the use of salt and nitrates to inhibit bacterial growth?",
    choice1: "Canning",
    choice2: "Pickling",
    choice3: "Salting",
    choice4: "Freezing",
  ...
  {
    question:
      "What is the primary component of baking powder that reacts to produce carbon dioxide gas?",
    choice1: "Baking soda",
